...
function validarDados(
  ...
  if (
    ...
    return {
      erro:
        'Local, turno e curso são obrigatórios.'
    }
  ...
  if (
    ...
    return res
      ...
      .json({
        ...
        message:
          'Não foi possível excluir a turma porque existem vínculos acadêmicos associados.'
